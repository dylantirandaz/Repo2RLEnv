...
│   ├── _pr_chain_controller.py # in-container `chain status|submit|log` — the env's step function
│   ├── _pr_chain_verifier.py   # terminal reward: re-verify every stage, mean of stage scores
